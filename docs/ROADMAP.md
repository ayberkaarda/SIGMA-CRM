...
| R2 | Reverb'ün Windows'ta çalıştırılması | WebSocket katmanı kalkmazsa tüm realtime fazlar etkilenir | Faz 4'te izole "merhaba dünya" event testiyle erken doğrulama; `REVERB_HOST/PORT` `.env.example`'da; port çakışması/loopback sorun giderme prosedürü README'de |
